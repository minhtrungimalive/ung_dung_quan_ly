...
function Tao_The_hien_Dien_thoai(Dien_thoai, Th_Cha) {
    ...
    var Chuoi_HTML = `<div class="card m-2 p-2" style="width:20rem ; margin-left: auto ; margin-right:auto;" Ma_so="${Dien_thoai.Ma_so}">
...
function Tao_The_hien_Dang_nhap(Th_Cha) {
    ...
    <button type="button" class="btn btn-primary" id="Th_Dang_nhap" style="margin ">Đăng nhập</button>
  </div>`
    Th_Cha.innerHTML = noi_dung_HTML
